  ...
  return (
    ...
    >
      <div className="flex items-center w-ful py-2">
        {/* logo */}
        <Link to="/">
          <FaPinterest className="w-20 h-10 text-red-500"/>
        </Link>

        {/* search box */}
        <div className="flex justify-between items-center w-full shadow-md bg-white p-2 rounded-lg mx-4"
        ...
        <div className="flex justify-center items-center">
          <Link to="create-pin">
            {/* <button
              type="button"
              className="w-10 h-10 min-w-20 p-2 text-base text-gray-700 border border-gray-300 
            rounded-full hover:shadow-xl duration-150 ease-in-out md:flex md:justify-center md:items-center hidden "
            >
              <BiPlus fontSize={24} className='text-black'/>
            </button> */}

            <motion.div className="bg-black w-10 h-10 rounded-md flex items-center justify-center"
            whileHover={{boxShadow: "2px 2px 8px 2px rgba(0,0,0,0.5)"}}
            >
