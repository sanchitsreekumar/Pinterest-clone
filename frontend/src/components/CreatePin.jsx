  ...
  return (
    <div className="flex-col flex justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        <motion.div className="bg-secondaryColor p-3 flex flex-0.7 w-full"
        initial={{opacity:0}}
        animate={{opacity:1}}
        ...
        {/* input fields */}
        <motion.div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full"
          variants={inputAnimationBlock}
          initial='hidden'
          animate='show'
